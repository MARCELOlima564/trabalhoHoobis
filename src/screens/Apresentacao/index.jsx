    ...
    <ScrollView style={styles.scrollContainer}>
      <View style={styles.container}>
        ...
        <View style={styles.divImagem}>
          <Image 
            source={require('../../../assets/Marcelo.png')} 
            style={styles.imagemMarcelo} 
          />
          <Text style={styles.textoApresentacao}>
            Meu nome é Marcelo Gabriel Correa Lima, tenho 18 anos e desde muito cedo, sempre fui apaixonado por tecnologia. Essa curiosidade começou ainda na infância, quando me interessei por computadores e comecei a explorar suas funcionalidades. Foi natural para mim que, ao crescer, eu quisesse aprender mais sobre como a tecnologia pode transformar o mundo e resolver problemas do dia a dia. Isso me motivou a ingressar no curso de Desenvolvimento de Sistemas no SENAI, onde pude aprender não só a programar, mas também a trabalhar de forma estratégica e criativa para desenvolver soluções inovadoras.
            ...
            Agora, com a conclusão do curso de Desenvolvimento de Sistemas se aproximando, estou empolgado para colocar em prática tudo o que aprendi e começar minha carreira no mercado de tecnologia. Tenho grande interesse em trabalhar com desenvolvimento de software, com o objetivo de criar soluções inovadoras que possam ajudar a melhorar a vida das pessoas. Estou pronto para novos desafios e ansioso para crescer como profissional e contribuir para a evolução da tecnologia.
          </Text>
        </View>
